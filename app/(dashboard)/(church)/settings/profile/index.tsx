              ...
              >
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    router.push("/(dashboard)/(church)/settings/profile/general");
                  }}
            ...
            <VStack className="gap-3">
              ...
              >
                <TouchableOpacity
                  ...
                  onPress={() => {
                    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                    router.push("/(dashboard)/(church)/settings/profile/language");
                  }}
                  className="cursor-pointer"
                >
                  <HStack className="items-center px-4 py-4">
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                    router.push("/(dashboard)/(church)/settings/profile/theme");
                  }}
                  className="cursor-pointer"
                >
                  <HStack className="items-center px-4 py-4">
